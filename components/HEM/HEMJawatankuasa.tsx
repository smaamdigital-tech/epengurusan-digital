...
export const HEMJawatankuasa: React.FC = () => {
  ...
  const handleDownloadPdf = async (mode: 'color' | 'bw') => {
    ...
    try {
      ...
      pdf.save(`Jawatankuasa_HEM_${activeLabel.replace(/\s+/g, '_')}_${mode}.pdf`);
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <h1 className="text-2xl font-bold text-gray-900">Pengurusan Jawatankuasa HEM</h1>
                <p className="text-sm text-gray-500 mt-1">Senarai jawatankuasa dan ahli bagi unit Hal Ehwal Murid.</p>
              </div>
              <button 
