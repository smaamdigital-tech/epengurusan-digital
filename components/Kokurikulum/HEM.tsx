...
const Icons = {
  ...
  Sync: () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="animate-spin"><path d="M21.5 2v6h-6"/><path d="M2.5 22v-6h6"/><path d="M2 11.5a10 10 0 0 1 18.8-4.3L21.5 8"/><path d="M22 12.5a10 10 0 0 1-18.8 4.3L2.5 16"/></svg>
};
        ...
        <div className="overflow-x-auto">
          {isLoading ? (
              <div className="p-12 text-center text-white flex flex-col items-center justify-center">
                  ...
                  <p>Memuatkan data dari Pangkalan Data...</p>
              </div>
          ) : (
      ...
      return (
        <div className="space-y-6 fade-in">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#1C2541] p-6 rounded-xl border border-gray-700 shadow-lg text-center"><h4 className="text-gray-400 text-sm font-bold uppercase tracking-wider">Jumlah Keseluruhan (Live)</h4><p className="text-4xl font-black text-white mt-2">{total}</p></div>
