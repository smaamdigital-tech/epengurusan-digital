...
const calendar2026Data: MonthData[] = [
  {
    id: 0,
    name: 'JANUARI 2026',
    islamicMonth: "REJAB - SYA'ABAN 1447",
  ...
  },
  {
    id: 1,
    name: 'FEBRUARI 2026',
    islamicMonth: "SYA'ABAN - RAMADAN 1447",
    headerColor1: 'bg-[#1a237e]',
    headerColor2: 'bg-[#2e7d32]',
    startDay: 0, 
    daysInMonth: 28,
    hijriDayStart: 13,
    hijriMonth1: "Sya'aban",
    hijriMonth2: "Ramadan",
                          ...
                          {days.map(d => {
                             ...
                             return (
                                <div key={d} className="relative border border-gray-300 md:border-2 md:border-gray-400 rounded-lg md:rounded-2xl min-h-[60px] md:min-h-[100px] bg-white flex flex-col overflow-hidden hover:shadow-md transition-shadow">
                                    <div className="absolute top-0.5 right-0.5 text-[8px] md:text-[11px] font-bold text-gray-500 leading-none tracking-tighter" style={{ fontFamily: '"Arial Narrow", sans-serif' }}>
                                        {getHijriLabel(month, d)}
                                    </div>
                                    <div className="w-full flex justify-center items-center pt-3 md:pt-4 flex-1">
                                        <span className={`text-2xl md:text-5xl font-serif font-bold z-10 ${event?.isHoliday ? 'text-red-600' : 'text-[#1a237e]'}`}>
                                            {d}
                                        </span>
                                    </div>
