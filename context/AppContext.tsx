...
const INITIAL_SPEECH_SCHEDULE_DATA: SpeechScheduleItem[] = [
  ...
  { id: 2, week: "2", date: "19 – 23 Jan 2026", group: "KUMPULAN 2", speaker: "Perhimpunan Bulanan Kokurikulum (1)", topic: "Sekolah Penyayang Murid Gemilang", civic: "KASIH SAYANG", sumur: "MUTADAYYIN" },
  ...
  { id: 6, week: "6", date: "16 – 20 Feb 2026", group: "KUMPULAN 6", speaker: "Perhimpunan Bulanan Kokurikulum (2)", topic: "Hormat Membina Hubungan Mengukuhkan Persahabatan", civic: "HORMAT MENGHORMATI", sumur: "MUTADAYYIN" },
  { id: 7, week: "7", date: "23 – 27 Feb 2026", group: "KUMPULAN 1", speaker: "Mohamad Nasreen Hakim bin Che Mohamed", topic: "Ramadhan Kareem", civic: "HORMAT MENGHORMATI", sumur: "MUTADAYYIN" },
  { id: 8, week: "8", date: "2 – 6 Mac 2026", group: "KUMPULAN 2", speaker: "Muhammad Hafiz bin Jalil", topic: "Adab dengan rakan", civic: "HORMAT MENGHORMATI", sumur: "MUTADAYYIN" },
  { id: 9, week: "9", date: "9 – 13 Mac 2026", group: "KUMPULAN 3", speaker: "Ahmad Fikruddin bin Ahmad Raza'i", topic: "Adab dan akhlak sebelum ilmu", civic: "HORMAT MENGHORMATI", sumur: "MUTADAYYIN" },
  { id: 10, week: "10", date: "16 – 20 Mac 2026", group: "KUMPULAN 4", speaker: "Perhimpunan Bulanan Kokurikulum (3)", topic: "Keutamaan sifat malu", civic: "BERTANGGUNG JAWAB", sumur: "MUTADAYYIN" },
  ...
  { id: 12, week: "12", date: "6 – 10 Apr 2026", group: "KUMPULAN 6", speaker: "Salman bin A Rahman", topic: "Hargai Diri", civic: "BERTANGGUNG JAWAB", sumur: "MUTADAYYIN" },
  { id: 13, week: "13", date: "13 – 17 Apr 2026", group: "KUMPULAN 1", speaker: "Perhimpunan Bulanan Kokurikulum (4)", topic: "Sayangi Sekolah", civic: "BERTANGGUNG JAWAB", sumur: "MUTADAYYIN" },
  { id: 14, week: "14", date: "20 – 24 Apr 2026", group: "KUMPULAN 2", speaker: "Muhammad Hafiz bin Jalil", topic: "Kejayaan tidak datang bergolek", civic: "KEGEMBIRAAN", sumur: "BUDI BAHASA" },
  { id: 15, week: "15", date: "27 Apr – 1 Mei 2026", group: "KUMPULAN 3", speaker: "Nooraind binti Ali", topic: "Mensyukuri Nikmat Sang Pencipta", civic: "KEGEMBIRAAN", sumur: "BUDI BAHASA" },
  { id: 16, week: "16", date: "4 – 8 Mei 2026", group: "KUMPULAN 4", speaker: "Mazuin binti Mat", topic: "Terima Kasih Warga Sekolah", civic: "KEGEMBIRAAN", sumur: "BUDI BAHASA" },
  ...
  { id: 18, week: "18", date: "18 – 22 Mei 2026", group: "KUMPULAN 6", speaker: "Perhimpunan Bulanan Kokurikulum (5)", topic: "Budi Bahasa Budaya Kita", civic: "KASIH SAYANG", sumur: "BUDI BAHASA" },
  { id: 19, week: "19", date: "8 – 12 Jun 2026", group: "KUMPULAN 1", speaker: "Nurul Syafiqah binti Husin", topic: "Sayangi Sahabat", civic: "KASIH SAYANG", sumur: "BUDI BAHASA" },
  { id: 20, week: "20", date: "15 – 19 Jun 2026", group: "KUMPULAN 2", speaker: "Perhimpunan Bulanan Kokurikulum (6)", topic: "Teguran Tanda Sayang", civic: "KASIH SAYANG", sumur: "BUDI BAHASA" },
  ...
  { id: 22, week: "22", date: "29 Jun – 3 Jul 2026", group: "KUMPULAN 4", speaker: "Siti Nurul Liza binti Sidin", topic: "Sikap Saling Menghormati", civic: "HORMAT MENGHORMATI", sumur: "JATI DIRI" },
  ...
  { id: 24, week: "24", date: "13 – 17 Jul 2026", group: "KUMPULAN 6", speaker: "Perhimpunan Bulanan Kokurikulum (7)", topic: "Tanggungjawab Seorang Pemimpin", civic: "BERTANGGUNG JAWAB", sumur: "JATI DIRI" },
  { id: 25, week: "25", date: "20 – 24 Jul 2026", group: "KUMPULAN 1", speaker: "Nor Hidayah binti Mahadun", topic: "", civic: "BERTANGGUNG JAWAB", sumur: "JATI DIRI" },
  { id: 26, week: "26", date: "27 – 31 Jul 2026", group: "KUMPULAN 2", speaker: "Syahidatun Najihah binti Aziz", topic: "Sayangi Buku Teks Anda", civic: "BERTANGGUNG JAWAB", sumur: "JATI DIRI" },
  ...
  { id: 28, week: "28", date: "10 – 14 Ogos 2026", group: "KUMPULAN 4", speaker: "Zarith Najiha binti Jamal", topic: "Sayangilah Alam Sekitar", civic: "KEGEMBIRAAN", sumur: "PENAMPILAN DIRI" },
  { id: 29, week: "29", date: "17 – 21 Ogos 2026", group: "KUMPULAN 5", speaker: "Perhimpunan Bulanan Kokurikulum (8)", topic: "Interaksi Sihat", civic: "KEGEMBIRAAN", sumur: "PENAMPILAN DIRI" },
  { id: 30, week: "30", date: "24 – 28 Ogos 2026", group: "KUMPULAN 6", speaker: "Mohammad Firros bin Rosool Gani", topic: "Jasamu Dikenang", civic: "KEGEMBIRAAN", sumur: "PENAMPILAN DIRI" },
  { id: 31, week: "31", date: "7 – 11 Sep 2026", group: "KUMPULAN 1", speaker: "Zahrah Khairiah Nasution binti Saleh", topic: "Pengorbanan Yang Berbaloi", civic: "KEGEMBIRAAN", sumur: "PENAMPILAN DIRI" },
  { id: 32, week: "32", date: "14 – 18 Sep 2026", group: "KUMPULAN 2", speaker: "Perhimpunan Bulanan Kokurikulum (9)", topic: "Pengurusan Emosi Menjelang Peperiksaan", civic: "KASIH SAYANG", sumur: "PENAMPILAN DIRI" },
  { id: 33, week: "33", date: "21 – 25 Sep 2026", group: "KUMPULAN 3", speaker: "Siti Aminah binti Mohamed", topic: "Cintai Malaysia", civic: "KASIH SAYANG", sumur: "PENAMPILAN DIRI" },
  { id: 34, week: "34", date: "28 Sep – 2 Okt 2026", group: "KUMPULAN 4", speaker: "Nurul Izzati binti Roslin", topic: "Indahnya Menutup Aurat", civic: "KASIH SAYANG", sumur: "PENAMPILAN DIRI" },
  { id: 35, week: "35", date: "5 – 9 Okt 2026", group: "KUMPULAN 5", speaker: "Nuurul Amira binti Razak", topic: "Rasulullah Qudwah Hasanah", civic: "KASIH SAYANG", sumur: "PENAMPILAN DIRI" },
  { id: 36, week: "36", date: "12 – 16 Okt 2026", group: "KUMPULAN 6", speaker: "Norliyana binti Mhd Amin", topic: "Toleransi Sesama Manusia", civic: "HORMAT MENGHORMATI", sumur: "PENAMPILAN DIRI" },
  { id: 37, week: "37", date: "19 – 23 Okt 2026", group: "KUMPULAN 1", speaker: "Perhimpunan Bulanan Kokurikulum (10)", topic: "Santuni al-Quran", civic: "HORMAT MENGHORMATI", sumur: "PENAMPILAN DIRI" },
  ...
  { id: 39, week: "39", date: "2 – 6 Nov 2026", group: "KUMPULAN 3", speaker: "Ahmad Fikruddin bin Ahmad Raza'i", topic: "Patriotisme Asas Kemajuan Negara", civic: "HORMAT MENGHORMATI", sumur: "PENAMPILAN DIRI" },
  { id: 40, week: "40", date: "9 – 13 Nov 2026", group: "KUMPULAN 4", speaker: "Mohamad Sukri bin Ali", topic: "Sayangi Harta Benda", civic: "BERTANGGUNG JAWAB", sumur: "PENAMPILAN DIRI" },
  { id: 41, week: "41", date: "16 – 20 Nov 2026", group: "KUMPULAN 5", speaker: "Perhimpunan Bulanan Kokurikulum (11)", topic: "Membazir Amalan Syaitan", civic: "BERTANGGUNG JAWAB", sumur: "PENAMPILAN DIRI" },
  { id: 42, week: "42", date: "23 – 27 Nov 2026", group: "KUMPULAN 6", speaker: "Liyana binti Iskandar", topic: "Tarbiah Asas Kecemerlangan", civic: "BERTANGGUNG JAWAB", sumur: "PENAMPILAN DIRI" },
...
const INITIAL_KOKO_ASSEMBLY_DATA: KokoAssemblyEvent[] = [
  { id: 1, month: 'Jan', date: '19 Jan 2026', unit: 'Kadet Remaja Sekolah', notes: 'Pakaian: Uniform Lengkap' },
  ...
  { id: 5, month: 'Mei', date: '18 Mei 2026', unit: 'Kadet Remaja Sekolah', notes: 'Pakaian: Uniform Lengkap' },
  ...
  { id: 9, month: 'September', date: '14 Sep 2026', unit: 'Kadet Remaja Sekolah', notes: 'Pakaian: Uniform Lengkap' },
